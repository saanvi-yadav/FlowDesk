...
import { getMainContentSx, getPageShellSx, getSurfaceSx, getTopbarSx } from "../theme";
...
export default function Settings() {
  ...
  const handlePasswordChange = async () => {
    if (!currentPwd) {
      showSnack("Enter your current password.", "error");
      return;
    }
    if (newPwd.length < 6) {
    ...
    <Box sx={getPageShellSx(theme)}>
      ...
      <Box sx={getMainContentSx()}>
        ...
        <Box sx={{ p: 4, maxWidth: 760 }}>
          <SectionCard
            icon={<PersonRoundedIcon sx={{ color: "#fff", fontSize: 18 }} />}
          ...
          >
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, mb: 2.5 }}>
              <Box>
                <Typography sx={{ fontSize: 12.5, fontWeight: 600, color: "#374151", mb: 0.8 }}>
                  Full Name
                </Typography>
                <TextField
                  fullWidth
          ...
          <SectionCard
            icon={<LockRoundedIcon sx={{ color: "#fff", fontSize: 18 }} />}
            title="Change Password"
            subtitle="Make sure your account stays secure"
          >
                    ...
                    InputProps={{
                      endAdornment: (
                        <InputAdornment position="end">
                          <IconButton onClick={field.toggle} size="small" sx={{ color: "#94a3b8" }}>
                            {field.show ? <VisibilityOff fontSize="small" /> : <Visibility fontSize="small" />}
                          </IconButton>
                        </InputAdornment>
                      ),
                    }}
